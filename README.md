...
```env
DEMO_MODE=true
GOLDEN_RESULT_PATH=tests/fixtures/uoe_golden.json
```
...
- `docs/UOE_ARCHITECTURE.md`: judge-friendly architecture overview.
- `docs/PROJECT_CHARTER.md`: submission-facing project positioning.
- `submission/`: UOE-ready descriptions, Devpost answers, demo runbook,
  winning checklist, slides, video script, and deploy notes.

## UOE Submission Pack

For UOE Summer of Code judging, start here:

- `submission/uoe_devpost_answers.md`: paste-ready submission copy.
...
- `docs/UOE_ARCHITECTURE.md`: simple architecture diagram and stage contracts.
