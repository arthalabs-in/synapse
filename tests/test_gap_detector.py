...
def test_unsupported_removal_patch_uses_the_result_id():
    operations = CoverageAuditorAgent()._patch_unsupported_slips(
        [
            {
    ...
    assert operations[0].result_ids == ["result_unsupported_001"]
