...
def sidebar_brand() -> None:
    st.markdown(
        """
        <div class="syn-sidebar-logo">SYN<span>/</span>APSE</div>
        <div class="syn-sidebar-note">Answers you can audit. Source quotes, fact IDs, patch reasons, validator proof.</div>
        """,
        unsafe_allow_html=True,
    )
